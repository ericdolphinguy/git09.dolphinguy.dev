...
class MockOAuthDataStore extends PPOAuthDataStore {/*{{{*/
    ...
    function __construct() {/*{{{*/
        $this->consumer = new PPOAuthConsumer("key", "secret", NULL);
        $this->request_token = new PPOAuthToken("requestkey", "requestsecret", 1);
        $this->access_token = new PPOAuthToken("accesskey", "accesssecret", 1);
        $this->nonce = "nonce";
    }/*}}}*/
