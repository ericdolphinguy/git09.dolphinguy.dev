<div class="booki">
<?php if(!Booki_Helper::hasEditorPermission()):?>
<div class="booki col-lg-12">
	<div class="booki-callout booki-callout-info">
		<h4><?php echo __('Stats', 'booki') ?></h4>
		<p><?php __('You do not have the necessary permissions to view stats.', 'booki') ?> </p>
	</div>
</div>
<?php else: ?>
	<?php
	...
	<div class="booki col-lg-12">
		<div class="booki-content-box">
			<div class="col-lg-3 booki-stats-block booki-stats-separator-equal-height">
				<h1 class="badge"><?php echo (int)$_Booki_StatsTmpl->donut[1] ?></h1>
				<h2><?php echo __('payments made', 'booki') ?></h2>
			</div>
			<div class="col-lg-5 booki-stats-block booki-stats-separator-equal-height">
	...
	<div class="booki col-lg-12">
		<div class="booki-content-box">
			...
			<div class="col-lg-5 booki-stats-block booki-stats-separator-equal-height">
				<h1 class="badge"><?php echo Booki_Helper::toMoney((int)$_Booki_StatsTmpl->totalAmountEarned) . ' ' . $_Booki_StatsTmpl->localInfo['currency'] ?></h1>
			...
			<div class="col-lg-4 booki-stats-block">
				<h1 class="badge"><?php echo Booki_Helper::toMoney((int)$_Booki_StatsTmpl->summary->discount) . ' ' . $_Booki_StatsTmpl->localInfo['currency']  ?></h1>
