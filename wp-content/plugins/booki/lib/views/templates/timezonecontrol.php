...
<div class="booki booki-timezone-control">
	<?php if(!$_Booki_TimezoneControlTmpl->autoTimezoneDetection):?>
	<input type="hidden" name="booki_timezone_selection" value="<?php echo $_Booki_TimezoneControlTmpl->timezone ?>" />
	<?php endif; ?>
...
jQuery(document).ready(function($){
	$(".booki-timezone-control").BookiTimezoneControl({
		...
		, "timezone": ".timezone"
		, "autoDetect": 'input[name="autodetect"]'
